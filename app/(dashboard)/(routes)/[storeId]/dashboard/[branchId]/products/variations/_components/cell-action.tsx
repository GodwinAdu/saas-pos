...
import { deleteVariation } from "@/lib/actions/variation.actions";
        ...
        <>
                ...
                <DropdownMenuContent align="end">
                    ...
                    {isLoading ? (
                        ...
                        <>
                            {role?.editUnit && (
                                <Link
                                    href={`/${params.storeId}/dashboard/${params.branchId}/products/units/${data?._id}`}
                                >
                                    <DropdownMenuItem>
            ...
            {isDeleteDialogOpen && (
                <DeleteDialog
                    ...
                    title="Are you sure you want to delete Variation?"
