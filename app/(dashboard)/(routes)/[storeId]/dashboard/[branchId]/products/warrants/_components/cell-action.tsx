...
import { deleteWarrant } from "@/lib/actions/warrant.actions"
                    ...
                    <>
                        {role?.editWarrant && (
                            <DropdownMenuItem asChild>
                                <Link href={`/${params.storeId}/dashboard/${params.branchId}/products/warrants/${data?._id}`}>
                        ...
                        {role?.deleteWarrant && (
                            <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="bg-red-500 hover:bg-red-800">
                                <DeleteDialog
                                    id={data?._id}
                                    title="Are you sure you want to delete this Warrant?"
